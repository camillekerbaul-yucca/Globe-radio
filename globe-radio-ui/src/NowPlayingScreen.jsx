...
const s = {
  ...
  statusIcon: { width: 22, height: 22, objectFit: "contain" },
  spotifyIconButton: {
    width: 30,
    height: 30,
    display: "grid",
  ...
  pillValue: { fontSize: 20, fontWeight: 600, color: "#fff" },
  ...
  likeButtonImg: { width: 64, height: 64, objectFit: "contain" },
  ...
  controlIcon: { width: 26, height: 26, objectFit: "contain" },
  playIcon: { width: 48, height: 48, objectFit: "contain" },
  ...
  modalTitle: { fontWeight: 700, fontSize: 18, color: "rgba(255,255,255,0.9)" },
  primaryButton: {
    padding: "10px 18px",
    borderRadius: 10,
  ...
  rowLabel: { opacity: 0.7, fontWeight: 600, fontSize: 14 },
  rowValue: { fontWeight: 700, fontSize: 14, color: "rgba(255,255,255,0.9)" },
};
