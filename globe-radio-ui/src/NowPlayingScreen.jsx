...
const s = {
  ...
  statusIcon: { width: 18, height: 18, objectFit: "contain" },
  spotifyIconButton: {
    width: 24,
    height: 24,
    display: "grid",
  ...
  pillValue: { fontSize: 18, fontWeight: 500, color: "#fff" },
  ...
  likeButtonImg: { width: 46, height: 46, objectFit: "contain" },
  ...
  controlIcon: { width: 20, height: 20, objectFit: "contain" },
  playIcon: { width: 36, height: 36, objectFit: "contain" },
  ...
  modalTitle: { fontWeight: 700, fontSize: 16, color: "rgba(255,255,255,0.9)" },
  primaryButton: {
    padding: "10px 16px",
    borderRadius: 10,
  ...
  rowLabel: { opacity: 0.7, fontWeight: 600, fontSize: 13 },
  rowValue: { fontWeight: 700, fontSize: 13, color: "rgba(255,255,255,0.9)" },
};
